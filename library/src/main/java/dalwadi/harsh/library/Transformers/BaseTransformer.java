package dalwadi.harsh.library.Transformers;
 ...
 *
 * BaseTransformer implement {@link dalwadi.harsh.library.Tricks.ViewPagerEx.PageTransformer}
 * which is just same as {@link android.support.v4.view.ViewPager.PageTransformer}.
 *
 * After you call setPageTransformer(), transformPage() will be called by {@link dalwadi.harsh.library.Tricks.ViewPagerEx}
 * when your slider are animating.
 *
 * In onPreTransform() function, that will make {@link dalwadi.harsh.library.Animations.BaseAnimationInterface}
 * work.
 *
