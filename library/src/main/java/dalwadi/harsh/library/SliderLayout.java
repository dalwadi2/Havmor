...
import dalwadi.harsh.library.Animations.BaseAnimationInterface;
import dalwadi.harsh.library.Indicators.PagerIndicator;
import dalwadi.harsh.library.SliderTypes.BaseSliderView;
import dalwadi.harsh.library.Transformers.AccordionTransformer;
import dalwadi.harsh.library.Transformers.BaseTransformer;
import dalwadi.harsh.library.Transformers.CubeInTransformer;
import dalwadi.harsh.library.Tricks.FixedSpeedScroller;
import dalwadi.harsh.library.Tricks.InfinitePagerAdapter;
import dalwadi.harsh.library.Tricks.InfiniteViewPager;
import dalwadi.harsh.library.Tricks.ViewPagerEx;

/**
 * SliderLayout is compound layout. This is combined with {@link dalwadi.harsh.library.Indicators.PagerIndicator}
 * and {@link dalwadi.harsh.library.Tricks.ViewPagerEx} .
 * <p>
...
public class SliderLayout extends RelativeLayout {
    ...
    /**
     * {@link dalwadi.harsh.library.Tricks.ViewPagerEx} indicator.
     */
    private PagerIndicator mIndicator;


    /**
     * A timer and a TimerTask using to cycle the {@link dalwadi.harsh.library.Tricks.ViewPagerEx}.
     */
    private Timer mCycleTimer;
    private TimerTask mCycleTask;

    /**
     * For resuming the cycle, after user touch or click the {@link dalwadi.harsh.library.Tricks.ViewPagerEx}.
     */
    private Timer mResumingTimer;
    private TimerTask mResumingTask;

    /**
     * If {@link dalwadi.harsh.library.Tricks.ViewPagerEx} is Cycling
     */
    private boolean mCycling;

    /**
     * Determine if auto recover after user touch the {@link dalwadi.harsh.library.Tricks.ViewPagerEx}
     */
    ...
    /**
     * {@link dalwadi.harsh.library.Tricks.ViewPagerEx} transformer time span.
     */
    ...
    /**
     * Visibility of {@link dalwadi.harsh.library.Indicators.PagerIndicator}
     */
    private PagerIndicator.IndicatorVisibility mIndicatorVisibility = PagerIndicator.IndicatorVisibility.Visible;

    /**
     * {@link dalwadi.harsh.library.Tricks.ViewPagerEx} 's transformer
     */
    private BaseTransformer mViewPagerTransformer;

    /**
     * @see dalwadi.harsh.library.Animations.BaseAnimationInterface
     */
    private BaseAnimationInterface mCustomAnimation;

    /**
     * {@link dalwadi.harsh.library.Indicators.PagerIndicator} shape, rect or oval.
     */
     ...
     * {@link dalwadi.harsh.library.Animations.BaseAnimationInterface},
     * and you can see a example in {@link dalwadi.harsh.library.Animations.DescriptionAnimation}
     *
     * @param animation
     */
    ...
    /**
     * get the {@link dalwadi.harsh.library.Indicators.PagerIndicator} instance.
