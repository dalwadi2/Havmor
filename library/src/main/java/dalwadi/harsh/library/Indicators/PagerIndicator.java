package dalwadi.harsh.library.Indicators;
...
import dalwadi.harsh.library.R;
...
public class PagerIndicator extends LinearLayout implements ViewPagerEx.OnPageChangeListener{
    ...
    /**
     * bind this Indicator with {@link dalwadi.harsh.library.Tricks.ViewPagerEx}
     */
    ...
    /**
     *This value is from {@link dalwadi.harsh.library.SliderAdapter} getRealCount() represent
     *
