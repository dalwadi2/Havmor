...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (i == 2) {
                v.getContext().startActivity(new Intent(v.getContext(), Address_view.class));
            }
            else if (i == 4) {
                Intent intent = new Intent(Intent.ACTION_SEND);
                intent.setType("text/plain");
                intent.putExtra(Intent.EXTRA_SUBJECT, "Havmor");
                String s = "\nTry this new Havmor Online Order Application\n\n";
                s = s + "my link here \n\n";
            ...
            {
                v.getContext().startActivity(new Intent(v.getContext(), Privacy_policy.class));
            }
        }
    }
    ...
    public void onBindViewHolder(MyAdapter.ViewHolder holder, int position) {
        if (holder.Holderid == 1) {                              // as the list view is going to be called after the header view so we decrement the
            ...
            /*if(position==3){
                holder.imageView.setPadding(100,0,0,0);
